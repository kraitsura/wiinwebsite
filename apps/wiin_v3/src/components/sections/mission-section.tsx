    ...
    <section id="mission" className="py-12 md:py-24 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-4 md:gap-12">
          <Link href="/benefits" className="border-2 border-foreground p-4 md:p-8 hover:bg-foreground/5 transition-colors">
          ...
          <Link href="/ingredients" className="border-2 border-foreground p-4 md:p-8 hover:bg-foreground/5 transition-colors">
          ...
          <Link href="/research" className="border-2 border-foreground p-4 md:p-8 hover:bg-foreground/5 transition-colors">
